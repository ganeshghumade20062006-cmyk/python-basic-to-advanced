...
# python functios starts from here
...
# 4.235294117647059
# second number is grater or equal
# 7.219512195121951


# output right.. self study of this topic
1
2
3
4
...
# the output is same in above 4 condition 
# but the methods of showing it is different
...
# output=no
# because in given condition 6 are present as an integer not as an string
...
# jump index
marks=[3,5,6,"ganesh", True,8,3,45,79,56,78,20,56,47]
print(marks[1:9])
print(marks[1:9])
print(marks[1:9:3])
# output[5, 6, 'ganesh', True, 8, 3, 45, 79]
# [5, True, 45]
# in 2nd line of output [5, True, 45]
# print(marks[1:9:3]) is the command 
# here length of marks is print upto 9 which is upto 79 
# but the difference is in [1:9:3].... the function of 3 is the length of marks is print but in the difference of 3 numbers 


marks=[3,5,6,"ganesh", True,8,3,45,79,56,78,20,56,47,58,33,74,56,88,69,21,45,56,74,10,1]
print(marks[1:9])
print(marks[0:])
print(marks[0::5])

# output=[5, 6, 'ganesh', True, 8, 3, 45, 79]
# [3, 5, 6, 'ganesh', True, 8, 3, 45, 79, 56, 78, 20, 56, 47, 58, 33, 74, 56, 88, 69, 21, 45, 56, 74, 10, 1]
# [3, 8, 78, 33, 21, 1] here print(marks[0::5]) is the command means print length of marks 0 to up to end and the difference between the numbers is 5
